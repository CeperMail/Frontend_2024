...
const users = [
  ...
  {name: "ishfani Ghiyath", age: 23, major: "informatics"},
  {name: "nurul", age: 21, major: "information system"},
  {name: "mail", age: 20, major: "informatics"},
  {name: "steve", age: 21, major: "information system"}
...
const update = (index, user) => {
  ...
  // menampilkan detail user yang sudah diupdate
...
const destroy = (index) => {
  if(users[index]) {
    users.splice(index,1);
      console.log("Successfully deleted the user's data");
      for(let user of users) {
        console.log(`Name   : ${user.name}`);
        console.log(`Age    : ${user.age}`);
        console.log(`Major  : ${user.major}\n`);
